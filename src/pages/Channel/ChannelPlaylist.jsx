      ...
      <div className="w-full relative text-white sm:px-5 px-0">
        ...
        {authId === userId && (
          <div className="w-full flex justify-center mt-5">
            <Button
              className="bg-gradient-to-r from-green-500 via-teal-500 to-blue-500 hover:text-white rounded-lg transition duration-200 p-2 text-sm"
              onClick={() =>
                setOpenCreatePlaylist((prev) => !prev)
              }
            >
          ...
          <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-transparent z-40">
            <div className="relative w-full max-w-sm border bg-black">
              ...
              >
                ...
                <Button
                  className="bg-gradient-to-r from-green-500 via-teal-500 to-blue-500 hover:text-white rounded-lg transition duration-200 p-2 w-full"
                  type="submit"
                >
                  Create Playlist
                </Button>
